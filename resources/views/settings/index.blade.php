        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white bg-slate-800 overflow-hidden shadow-sm">
                <div class="p-6">
                    ...
                    @endif
                    <form class="w-full"  method="POST" action="{{ route('settings.store', ['locale' => app()->getLocale()])}}">
                        @csrf
                        ...
                        <div class="flex flex-wrap -mx-3 mb-6">
                            <div class="w-full md:w-1/3 px-3">
                                ...
                                <input
                                    class="appearance-none block w-full bg-gray-200 text-gray-700 border py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white"
                                    type="text" id="lang" name="lang" class="form-control"
                                    required="">
                            </div>
                            <div class="w-full md:w-1/3 px-3">
                                <label
                            ...
                            <div class="w-full md:w-1/3 px-3">
                                ...
                                <input
                                    class="appearance-none block w-full bg-gray-200 text-gray-700 border py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white"
                                    type="text" id="bank_account" name="bank_account" class="form-control"
                                    required="">
                            </div>
                        </div>
                        <div class="flex flex-wrap -mx-3 mb-6">
