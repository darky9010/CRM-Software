...
class ReportController extends Controller
{
    ...
    public function index(Request $request)
    {
         ...
         */
        public
        function store(StoreReportRequest $request)
        {
            $report = new Report;
            $d = $request->type[0];
            $year = date('y',);
         ...
         */
        public
        function update(UpdateReportRequest $request, $locale, $id)
        {
            $report = Report::find($id);
         ...
         */
        public
        function removeProduct($locale, $report, $product)
        {
         ...
         */
        public
        function delete($locale, $id, $type)
        {
         ...
         */
        public
        function destroy($locale, $id, $type)
        {
